...
function initBoutonsAnimes() {
   ...
   *
   * Désormais l'effet se demande, il ne s'hérite pas.
   */
 ...
 *
 * LE MOTEUR est refait, comme pour le libellé des boutons. La ressource repose sur GSAP et son greffon ScrollTrigger servis par
